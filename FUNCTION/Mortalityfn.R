source("c:/Users/ghkdw/OneDrive/바탕 화면/황지연/NaverCloud/R-CODE/FUNCTION/llmodel.r")
...
lcax %>%as.data.frame()%>%reshape2::melt(id.vars="STD_DT")%>%ggplot(aes(x=STD_DT, y=value, col = variable)) +             
