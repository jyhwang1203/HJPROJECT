...
ipak(pkg)
      ...
      mutate(STD_DT=as.Date(STD_DT))%>%mutate(AL=(CRBTR+WREPRA+WRINFRA)/3)
    ...
    #     
      ...
      eq     <- RAWDATA%>%select(STD_DT,WORLD,DM,EM,DOW,SP500,NASDAQ,KOSPI,EURO50,FTSE,NIKKEI,NIFTY,DAX,CAC,TSX,BVSP,NIFTY,SHANGHAI,CSI300,HANGS,
      ...
      feps <- RAWDATA%>%select(STD_DT,FEPS_WORLD,FEPS_DM,FEPS_EM,FEPS_DOW,FEPS_SP500,FEPS_NASDAQ,FEPS_KOSPI,FEPS_EURO50,FEPS_FTSE,FEPS_NIKKEI,FEPS_NIFTY,FEPS_DAX,
                               FEPS_CAC,FEPS_TSX,FEPS_BVSP,FEPS_NIFTY,FEPS_SHANGHAI,FEPS_CSI300,FEPS_HANGS,
      ...
      retm <-  RAWDATA %>%trans_rt("month")%>%dt_trans()%>% mutate(AL=1/3*(WRINFRA+WREPRA+CRBTR))%>%
      ...
      retfeps_ytd<- ret2_ytd %>% dt_trans%>%select(STD_DT,FEPS_WORLD,FEPS_DM,FEPS_EM,FEPS_DOW,FEPS_SP500,FEPS_NASDAQ,FEPS_KOSPI,FEPS_EURO50,FEPS_FTSE,FEPS_NIKKEI,FEPS_NIFTY,FEPS_DAX,
                                                   FEPS_CAC,FEPS_TSX,FEPS_BVSP,FEPS_NIFTY,FEPS_SHANGHAI,FEPS_CSI300,FEPS_HANGS,FEPS_USGROWTH,FEPS_USVALUE,FEPS_USLVOL,FEPS_USHDIV,FEPS_USMOM,
                                                   FEPS_USQUAL,FEPS_KRGROWTH,FEPS_KRVALUE)%>% exname()
